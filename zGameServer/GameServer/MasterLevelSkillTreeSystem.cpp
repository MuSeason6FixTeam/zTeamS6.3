...
#include "logproc.h"
#include "GameMain.h"
#include "GameServer.h" //maybe
#include "User.h" //maybe
#include "MoveCommand.h" //maybe
#include "LuaFun.h"
	...
	case 559:
		{
			...
			//{
				//for(int i = 0; i < 5; i++)
				//{
					//if( /*lpObj->m_wDarkSideTargetList[i]*/lpObj->m_Index != OBJMAX )//10000 
						this->MLS_SkillMonkBarrageJustOneTarget(lpObj->m_Index,lpMagic,/*lpObj->m_wDarkSideTargetList[i]*/aTargetIndex);
				//}
			//}
		}
		break;
...
int CMasterLevelSkillTreeSystem::MLS_KnightBlow(int aIndex,int aTargetIndex,CMagicInf *lpMagic,int isCombo)
{
	...
	this->MLS_SkillFrustrum(aIndex,fangle,1.5f,3.0f);
